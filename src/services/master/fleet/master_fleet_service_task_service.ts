...
// ✅ Master Fleet Service Task Create/Update Schema
...
// ✅ Master Fleet Service Task Query Schema
export const MasterFleetServiceTaskQuerySchema = BaseQuerySchema.extend({
  organisation_ids: multi_select_optional('Organisation'), // ✅ Multi-selection -> UserOrganisation
  fleet_service_task_ids: multi_select_optional('Fleet Service Task'), // ✅ Multi-selection -> MasterFleetServiceTask
});
...
export const toMasterFleetServiceTaskPayload = (
  task: MasterFleetServiceTask
): MasterFleetServiceTaskDTO => ({
  organisation_id: task.organisation_id ?? '',
  fleet_service_task: task.fleet_service_task,
  status: task.status,
});

// Generate a new payload with default values
export const newMasterFleetServiceTaskPayload =
  (): MasterFleetServiceTaskDTO => ({
    organisation_id: '',
    fleet_service_task: '',
...
// API Methods
export const findMasterFleetServiceTasks = async (
  data: MasterFleetServiceTaskQueryDTO
): Promise<FBR<MasterFleetServiceTask[]>> => {
  return apiPost<FBR<MasterFleetServiceTask[]>, MasterFleetServiceTaskQueryDTO>(
    ENDPOINTS.find,
    data
  );
};

export const createMasterFleetServiceTask = async (
  data: MasterFleetServiceTaskDTO
): Promise<SBR> => {
  return apiPost<SBR, MasterFleetServiceTaskDTO>(ENDPOINTS.create, data);
};

export const updateMasterFleetServiceTask = async (
  id: string,
  data: MasterFleetServiceTaskDTO
): Promise<SBR> => {
...
export const deleteMasterFleetServiceTask = async (
  id: string
): Promise<SBR> => {
...
// API Cache Methods
export const getMasterFleetServiceTaskCache = async (
  organisation_id: string
): Promise<FBR<MasterFleetServiceTask[]>> => {
  return apiGet<FBR<MasterFleetServiceTask[]>>(
