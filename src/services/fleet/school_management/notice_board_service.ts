...
const URL = 'fleet/school_management/notice_board';

const ENDPOINTS = {
    // OrganisationNoticeBoard APIs
    find: `${URL}/search`,
    create: URL,
...
// Convert OrganisationNoticeBoard Data to API Payload
...
// Create New OrganisationNoticeBoard Payload
