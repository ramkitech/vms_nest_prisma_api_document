...
export const FleetServiceScheduleSchema = z.object({
  ...
  service_schedule_description: stringOptional('Service Schedule Description', 0, 2000),
...
export type FleetServiceScheduleDTO = z.infer<typeof FleetServiceScheduleSchema>;
...
export type FleetServiceScheduleQueryDTO = z.infer<typeof FleetServiceScheduleQuerySchema>;
...
export const toFleetServiceSchedulePayload = (row: FleetServiceSchedule,): FleetServiceScheduleDTO => ({
  ...
  vehicle_ids:
    row.FleetServiceScheduleVehicleLink?.map((l) => l.vehicle_id) || [],
